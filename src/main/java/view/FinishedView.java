...
import view.config.msgviewconfig.FinishedLabelConfig;
import view.config.storefileconfig.PreviousBtnConfig;
import view.dataholder.ViewData;

public class FinishedView extends ViewComponentCreater implements ActionListener{
	//ボタンを作成する
	...
	public JPanel createMsgPanel() {
		 ...
		 *メッセージパネルを作成するメソッド
		 */
		JLabel label = this.createLabel(new FinishedLabelConfig());
