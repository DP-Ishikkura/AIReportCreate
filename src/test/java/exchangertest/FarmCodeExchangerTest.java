...
public class FarmCodeExchangerTest {
	...
	public static void setUpBeforeClass() throws Exception {
		System.out.println("FarmCodeExchangeのテスト開始");
	}

	@AfterAll
	public static void tearDownAfterClass() throws Exception {
		System.out.println("FarmCodeExchangeのテスト終了");
	}
	...
	@Test
	public void testFarmNameList() throws JsonParseException, JsonMappingException, IOException {
		/*
		 * 農場名一覧を正常に取得できるかテスト
		 */
		...
		FarmCodeData Fce = setJHC().createFarmCodeHolder();
		List<String> values = Fce.getFarmNameList();
		assertEquals(correct_list, values);
	}
	
	
	@Test
	public void testFarmCodeList() throws JsonParseException, JsonMappingException, IOException {
		/*
		 * 農場名一覧を正常に取得できるかテスト
		 */
		List<String> correct_list = new ArrayList<>(Arrays.asList(
		...
		FarmCodeData Fce = setJHC().createFarmCodeHolder();
		List<String> values = Fce.getFarmCodeList();
		assertEquals(correct_list, values);
	}
	
	@Test
	public void testFarmCodeInUD() throws Exception {
		/*
		 * UnionedListの中に農コードが作成されているかテストする
		 */
		List<String> correct_list = new ArrayList<>(Arrays.asList(
				"158442077","158442077","158442077","158442077","158442077","158442077" ,"158442077","158442077" 
				));
		...
		//テスト
		assertEquals(correct_list, Udl.getFarmCodeList());
